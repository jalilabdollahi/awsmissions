...
aws_local dynamodb put-item --table-name MissionTable --item '{"id":{"S":"item-1"},"status":{"S":"OPEN"}}' >/dev/null
echo "Broken state prepared: query uses reserved word status without expression attribute names"
