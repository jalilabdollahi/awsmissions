...
aws_local lambda put-function-concurrency   --function-name mission-function   --reserved-concurrent-executions 0 >/dev/null

echo "Broken function created: reserved concurrency is 0"
