...
aws_local lambda create-function-url-config   --function-name mission-function   --auth-type AWS_IAM >/dev/null 2>&1 || true

echo "Broken function created: function URL auth type is AWS_IAM"
